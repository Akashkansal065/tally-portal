...
class LowerDeductionCertificate(Base):
    ...
    party_ledger_id = Column(Integer, ForeignKey("ledgers.ledger_id"), nullable=False)
    section_id = Column(Integer, ForeignKey("tds_sections.section_id"), nullable=False)
...
class TdsTcsEntry(Base):
    ...
    certificate_id = Column(Integer, ForeignKey("lower_deduction_certificates.certificate_id"), nullable=True)
...
class ChallanEntryMap(Base):
    ...
    challan_id = Column(Integer, ForeignKey("tax_challans.challan_id", ondelete="CASCADE"), nullable=False)
    entry_id = Column(BigInteger, ForeignKey("tds_tcs_entries.entry_id", ondelete="CASCADE"), nullable=False)
