...
class GstReturnPeriod(Base):
    ...
    filed_by = Column(Integer, ForeignKey("users.user_id"), nullable=True)
...
class Gstr1LineItem(Base):
    ...
    return_period_id = Column(BigInteger, ForeignKey("gst_return_periods.return_period_id", ondelete="CASCADE"), nullable=False)
    voucher_id = Column(BigInteger, ForeignKey("vouchers.voucher_id"), nullable=False)
...
class Gstr3bSummary(Base):
    ...
    return_period_id = Column(BigInteger, ForeignKey("gst_return_periods.return_period_id", ondelete="CASCADE"), nullable=False, unique=True)
...
class ItcEntry(Base):
    ...
    claimed_return_period_id = Column(BigInteger, ForeignKey("gst_return_periods.return_period_id", ondelete="SET NULL"), nullable=True)
